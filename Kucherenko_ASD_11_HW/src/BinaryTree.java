...
public class BinaryTree<T> {
    ...
    public BinaryTree(T rootValue) {
        ...
        if (exceptions == 0) {
            this.root = new PrefixNode<>(rootValue);
            length++;
        }
    }
    ...
    public void addLeftChild(T elementToAdd, T element) {
        int exceptions = 0;
        PrefixNode<T> nodeOfElementToAdd = findNodeFromEl(root, elementToAdd);
        try {
        ...
        if (exceptions == 0) {
            nodeOfElementToAdd.leftChild = new PrefixNode<>(element);
    ...
    public void addRightChild(T elementToAdd, T element) {
        ...
        if (exceptions == 0) {
            nodeOfElementToAdd.rightChild = new PrefixNode<>(element);
    ...
    public void delete(T element) {
        ...
        if (exceptions == 0) {
            PrefixNode<T> nodeToDelete = findNodeFromEl(root, element);
    ...
    private String toString(PrefixNode<T> root) {
        String res = "";
    ...
    private boolean containsRecursive(PrefixNode<T> nodeToStartWith, T valueToSearchFor) {
